...
struct drum_hit drum_hit[16] = {
	...
	{0,0,8, 1<<BD_TRIG, 255, 0, 2, 1<<BD_LED},
	{1,0,8, 1<<SD_TRIG, 255, 0, 2, 1<<SD_LED},
	{2,0,8, 1<<LT_TRIG, 1<<LT_LC_SW, 1, 2, 1<<LT_LED},	
	{3,0,8, 1<<MT_TRIG, 1<<MT_MC_SW, 1, 7, 1<<MT_LED},
	{4,0,8, 1<<HT_TRIG, 1<<HT_HC_SW, 1, 7, 1<<HT_LED},
	{5,0,8, 1<<RS_TRIG, 1<<RS_CL_SW, 0, 7, 1<<RS_LED},
	{6,0,8, 1<<CP_TRIG, 255, 0, 7, 1<<CP_LED},
	{7,0,6, 1<<CB_TRIG, 255, 0, 7, 1<<CB_LED},
	{8,0,6, 1<<CY_TRIG, 255, 0, 7, 1<<CY_LED},
	{9,0,6, 1<<OH_TRIG, 255, 0, 6, 1<<OH_LED},
	{10,0,6, 1<<CH_TRIG,255, 0, 6, 1<<CH_LED},
	{11,0,8, 1<<LT_TRIG, 1<<LT_LC_SW, 0, 3, 1<<LC_LED},
	{12,0,8, 1<<MT_TRIG, 1<<MT_MC_SW, 0, 3, 1<<MC_LED},
	{13,0,8, 1<<HT_TRIG, 1<<HT_HC_SW, 0, 3, 1<<HC_LED},
	{14,0,8, 1<<RS_TRIG, 1<<RS_CL_SW, 1, 3, 1<<CL_LED},
	{15,0,7, 1<<MA_TRIG, 255, 0, 7, 1<<MA_LED}											
	};
